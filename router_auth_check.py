...
VENDOR_DEFAULTS = {
    ...
    "TP-Link":     [("admin", "admin"), ("admin", ""), ("admin", "1234")],
    ...
    "Keenetic":    [("admin", ""), ("admin", "admin")],
    "LANCOM":      [("admin", "admin"), ("admin", ""), ("admin", "1234")],
    "SonicWALL":   [("admin", "password"), ("admin", "admin")],
    "OpenWrt":     [("root", ""), ("root", "admin")],
    "DD-WRT":      [("root", "admin")],
    "Tomato":      [("root", "admin")],
    "Huawei":      [("admin", "admin"), ("admin", ""), ("telecomadmin", "admintelecom"), ("admin", "1234")],
    "Ubiquiti":    [("ubnt", "ubnt"), ("admin", "ubnt")],
    "ASUS":        [("admin", "admin"), ("admin", "")],
    "Tenda":       [("admin", "admin")],
    "Sagemcom":    [("admin", "admin"), ("admin", "1234")],
    "Generic DSL Router": [("admin", "admin"), ("admin", "1234"), ("admin", "password"),
                           ("user", "user"), ("admin", "")],
    "GoAhead":     [("admin", ""), ("admin", "admin")],
    "miniupnpd":   [("admin", ""), ("admin", "admin")],
    "micro_httpd": [("admin", ""), ("admin", "admin"), ("admin", "1234")],
    "httpd":       [("admin", "admin"), ("admin", ""), ("root", "root")],
}
...
GENERIC_POPULAR = [
    ...
    ("admin", "123456"), ("admin", ""), ("admin", "admin123"), ("admin", "12345678"),
    ("root", "root"), ("root", "admin"), ("root", "toor"), ("user", "user"),
    ("guest", "guest"), ("admin", "changeme"), ("support", "support"), ("admin", "pass"),
]
